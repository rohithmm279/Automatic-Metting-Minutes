"""Standalone Qwen 2.5 3B Meeting Analysis Test

Tests the improved prompt adhering strictly to the 10 meeting-analysis rules
against the SC001 student club transcript.
"""
...
def build_prompt(transcript: str) -> str:
    """Build the improved standalone meeting-analysis prompt for Qwen 2.5 3B."""
...
def run_test():
    ...
    transcript_path = repo_root / "datasets" / "01_PRIMARY" / "student_club" / "transcripts" / "SC001.txt"
    ...
    try:
        ...
        print(f"Error parsing JSON: {err}", file=sys.stderr)
        sys.exit(1)
